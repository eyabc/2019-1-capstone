<template>
      ...
      <ul class="visibility">
        <li>
         ...
         <span class="checks etrans">
          <input type="checkbox" id="cb1" name="visibility_oneChat">
          <label for="cb1"></label>
        </span>
      </li>
      <li>
       <span>위치 공개</span>
       <span class="checks etrans">
        <input type="checkbox" id="cb2" name="visibility_place"> 
        <label for="cb2"></label>
      </span>
    </li>
  </ul>
  ...
  <li>
   <label class="input-label">
    ...
    <input type="password" name="password" class="full-width" placeholder="비밀번호">
  </label>
</li>
<li>
 <label class="input-label">
  <span class="pre"><i class="fas fa-key"></i></span>
  <input type="password" name="password-re" class="full-width" required placeholder="비밀번호 재확인">
</label>
</li>
<li>
 <label class="input-label">
